@echo OFF
REM Good batch guide: https://www.tutorialspoint.com/developers_best_practices/index.htm
...
IF EXIST device_1_file.txt ECHO Device 1: %device1_properties%
IF EXIST device_2_file.txt ECHO Device 2: %device2_properties%
